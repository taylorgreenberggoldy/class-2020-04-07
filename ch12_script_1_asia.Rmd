...
**Prompt:** Now let's quantify these relationships between the two explanatory variables and the outcome variable. Fit a multiple gression model for `earnings` using `sat` and `faculty`. Write a bullet point interpreting each of the three values in the estimate column.
